...
describe('Path', function () {
  ...
  it('Able to determine points on Elliptical Arc with clockwise stroke', function () {
    ...
    assert.equal(
      c,
      'M 50 100 63.39745962155612 75.00000000000001 99.99999999999996 56.698729810778076 149.99999999999997 50 200 56.69872981077807 236.60254037844388 75.00000000000001 250 100.00000000000003 236.60254037844382 125.00000000000004 199.9999999999999 143.30127018922195 150.00000000000003 150'
    );
  });
  ...
  it('Able to determine points on Elliptical Arc when rotated', function () {
    ...
    assert.equal(
      c,
      'M 250 99.99999999999999 209.63024270137728 69.46654531272594 162.9710386647049 50.769536422212866 122.52468393108823 48.91882176155127 99.12874658818252 64.41029882948584 99.0521491531885 93.09303885609827 122.31541584695515 127.28152481454595 150 150'
    );
  });
