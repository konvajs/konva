...
describe('Spline', function () {
  ...
  // ======================================================
  it('update spline points', function () {
    var stage = addStage();
    var layer = new Konva.Layer();
    ...
    spline.points([73, 160, 340, 23, 500, 109]);
  ...
  // ======================================================
  it('add point to spline points', function () {
    var stage = addStage();
    var layer = new Konva.Layer();
    ...
    assert.equal(spline.points().length, 8);
    ...
    assert.equal(spline.points().length, 10);
