Test.prototype.tests = {
    ...
    '*PATH - Quadradic Curve test from SVG w3c spec' : function (containerId) {
        ...
        layer.add(new Kinetic.Plugins.Path({
    ...
    '*PATH - Tiger (RAWR!)' : function (containerId) {
        ...
        for (var i = 0; i < tiger.length; i++) {
            var path = new Kinetic.Plugins.Path(tiger[i]);
            group.add(path);
        }
    ...
    '*PATHHELPER - Able to determine point on line some distance from another point on line' : function (containerId) {
        ...
        var c = "M10,10 210,160"; // i.e., from a 3-4-5 triangle
        ...
        var p1 = Kinetic.Plugins.PathHelper.getPointOnLine(125, 10, 10, 210, 160); // should be 1/2 way, or (110,85)
    ...
    '*PATHHELPER - Able to determine points on Cubic Bezier Curve' : function (containerId) {
        ...
        for (t = 0.25; t <= 1; t += 0.25) {
            var p1 = Kinetic.Plugins.PathHelper.getPointOnCubicBezier(t, 100, 200, 100, 100, 250, 100, 250, 200);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
        }
        
        for (t = 0.25; t <= 1; t += 0.25) {
            var p1 = Kinetic.Plugins.PathHelper.getPointOnCubicBezier(t, 250, 200, 250, 300, 400, 300, 400, 200);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
        }
    ...
    '*PATHHELPER - Able to determine points on Quadratic Curve' : function (containerId) {
        ...
        for (t = 0.333; t <= 1; t += 0.333) {
            var p1 = Kinetic.Plugins.PathHelper.getPointOnQuadraticBezier(t, 200, 300, 400, 50, 600, 300);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
        }
        
        for (t = 0.333; t <= 1; t += 0.333) {
            var p1 = Kinetic.Plugins.PathHelper.getPointOnQuadraticBezier(t, 600, 300, 800, 550, 1000, 300);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
        }
    ...
    '*PATHHELPER - Able to determine points on Elliptical Arc with clockwise stroke' : function (containerId) {
        ...
        var centerParamPoints = Kinetic.Plugins.PathHelper.convertEndpointToCenterParameterization(50, 100, 150, 150, 1, 1, 100, 50, 0);
        ...
        var p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], start, 0);
            c = 'M ' + p1.x.toString() + ' ' + p1.y.toString();
        
        if (dTheta < 0) // clockwise
        {
            for (t = start - inc; t > end; t -= inc) {
                p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], t, 0);
                    c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
            }
        ...
        p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], end, 0);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
    ...
    '*PATHHELPER - Able to determine points on Elliptical Arc with counter-clockwise stroke' : function (containerId) {
        ...
        var centerParamPoints = Kinetic.Plugins.PathHelper.convertEndpointToCenterParameterization(250, 100, 150, 150, 1, 0, 100, 50, 0);
    ...
    '*PATHHELPER - Able to determine points on Elliptical Arc when rotated' : function (containerId) {
        ...
        var centerParamPoints = Kinetic.Plugins.PathHelper.convertEndpointToCenterParameterization(250, 100, 150, 150, 1, 0, 100, 50, 30);
        ...
        var p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], start, psi);
            c = 'M ' + p1.x.toString() + ' ' + p1.y.toString();
        
        if (dTheta < 0) // clockwise
        {
            for (t = start - inc; t > end; t -= inc) {
                p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], t, psi);
                    c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
            }
        } else // counter-clockwise
        {
        ...
        p1 = Kinetic.Plugins.PathHelper.getPointOnEllipticalArc(centerParamPoints[0], centerParamPoints[1], centerParamPoints[2], centerParamPoints[3], end, psi);
            c += ' ' + p1.x.toString() + ' ' + p1.y.toString();
    ...
    '*PATH - Borneo Map (has scientific notation: -10e-4)' : function (containerId) {
        ...
        var borneo = new Kinetic.Plugins.Path({
