declare module Konva {
        ...
        class Container extends Node {
            ...
            clip(): SizeConfig;
            clip(clip: SizeConfig | undefined | null): Container;
            clipHeight(): number;
            clipHeight(clipHeight: number | undefined | null): Container;
            clipWidth(): number;
            clipWidth(clipWidth: number | undefined | null): Container;
            clipX(): number;
            clipX(clipX: number | undefined | null): Container;
            clipY(): number;
            clipY(clipY: number | undefined | null): Container;
            clipFunc(): (ctx: CanvasRenderingContext2D) => void;
